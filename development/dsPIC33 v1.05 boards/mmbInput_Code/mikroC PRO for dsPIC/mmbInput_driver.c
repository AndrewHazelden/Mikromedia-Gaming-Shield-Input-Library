...
static void InitializeObjects() {
  ...
  Led1Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  Led2Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  Led3Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  Led4Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  left.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  right.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  up.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  down.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  square.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  circle.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  triangle.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  x.Caption         = x_Caption;
  x.TextAlign            = _taLeft;
  x.FontName        = DejaVu_Sans_Mono8x15_Bold;
  x.PressColEnabled = 1;
  x.Font_Color      = 0xFFFF;
  x.Gradient        = 1;
  ...
  start.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  StatusLEDsText.FontName        = DejaVu_Sans_Mono8x15_Bold;
  ...
  ProgramCaption.FontName        = DejaVu_Sans_Mono17x34_Bold;
  ...
  MCU.FontName        = DejaVu_Sans_Mono17x34_Bold;
