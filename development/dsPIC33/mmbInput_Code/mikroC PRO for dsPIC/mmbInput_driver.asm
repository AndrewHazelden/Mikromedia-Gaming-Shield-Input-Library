...
;mmbInput_driver.c,262 :: 		Led1Button.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,263 :: 		Led1Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
...
;mmbInput_driver.c,291 :: 		Led2Button.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,292 :: 		Led2Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
...
;mmbInput_driver.c,320 :: 		Led3Button.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,321 :: 		Led3Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
...
;mmbInput_driver.c,349 :: 		Led4Button.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,350 :: 		Led4Button.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
...
;mmbInput_driver.c,368 :: 		left.Top             = 141;
	MOV	#141, W0
	MOV	W0, _left+6
;mmbInput_driver.c,369 :: 		left.Width           = 68;
	MOV	#68, W0
	MOV	W0, _left+8
...
;mmbInput_driver.c,378 :: 		left.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,379 :: 		left.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _left+24
	MOV	W1, _left+26
...
;mmbInput_driver.c,397 :: 		right.Top             = 141;
	MOV	#141, W0
	MOV	W0, _right+6
;mmbInput_driver.c,398 :: 		right.Width           = 76;
	MOV	#76, W0
	MOV	W0, _right+8
...
;mmbInput_driver.c,407 :: 		right.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,408 :: 		right.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _right+24
	MOV	W1, _right+26
...
;mmbInput_driver.c,426 :: 		up.Top             = 109;
	MOV	#109, W0
	MOV	W0, _up+6
;mmbInput_driver.c,427 :: 		up.Width           = 52;
	MOV	#52, W0
	MOV	W0, _up+8
...
;mmbInput_driver.c,436 :: 		up.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,437 :: 		up.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _up+24
	MOV	W1, _up+26
...
;mmbInput_driver.c,455 :: 		down.Top             = 173;
	MOV	#173, W0
	MOV	W0, _down+6
;mmbInput_driver.c,456 :: 		down.Width           = 68;
	MOV	#68, W0
	MOV	W0, _down+8
...
;mmbInput_driver.c,465 :: 		down.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,466 :: 		down.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _down+24
	MOV	W1, _down+26
...
;mmbInput_driver.c,484 :: 		square.Top             = 140;
	MOV	#140, W0
	MOV	W0, _square+6
;mmbInput_driver.c,485 :: 		square.Width           = 60;
	MOV	#60, W0
	MOV	W0, _square+8
...
;mmbInput_driver.c,494 :: 		square.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,495 :: 		square.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _square+24
	MOV	W1, _square+26
...
;mmbInput_driver.c,513 :: 		circle.Top             = 140;
	MOV	#140, W0
	MOV	W0, _circle+6
;mmbInput_driver.c,514 :: 		circle.Width           = 68;
	MOV	#68, W0
	MOV	W0, _circle+8
...
;mmbInput_driver.c,523 :: 		circle.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,524 :: 		circle.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _circle+24
	MOV	W1, _circle+26
...
;mmbInput_driver.c,542 :: 		triangle.Top             = 108;
	MOV	#108, W0
	MOV	W0, _triangle+6
;mmbInput_driver.c,543 :: 		triangle.Width           = 60;
	MOV	#60, W0
	MOV	W0, _triangle+8
...
;mmbInput_driver.c,552 :: 		triangle.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,553 :: 		triangle.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _triangle+24
	MOV	W1, _triangle+26
...
;mmbInput_driver.c,571 :: 		x.Top             = 172;
	MOV	#172, W0
	MOV	W0, _x+6
;mmbInput_driver.c,572 :: 		x.Width           = 44;
	MOV	#44, W0
	MOV	W0, _x+8
...
;mmbInput_driver.c,581 :: 		x.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,582 :: 		x.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _x+24
	MOV	W1, _x+26
...
;mmbInput_driver.c,600 :: 		start.Top             = 204;
	MOV	#204, W0
	MOV	W0, _start+6
;mmbInput_driver.c,601 :: 		start.Width           = 76;
	MOV	#76, W0
	MOV	W0, _start+8
...
;mmbInput_driver.c,610 :: 		start.TextAlign            = _taLeft;
	...
	CLR	W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,611 :: 		start.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
	MOV	W0, _start+24
	MOV	W1, _start+26
...
;mmbInput_driver.c,638 :: 		StatusLEDsText.TextAlign             = _taCenter;
	...
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,639 :: 		StatusLEDsText.FontName        = DejaVu_Sans_Mono8x15_Bold;
	MOV	#113, W0
	MOV	#0, W1
...
;mmbInput_driver.c,665 :: 		ProgramCaption.TextAlign             = _taCenter;
	...
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,666 :: 		ProgramCaption.FontName        = DejaVu_Sans_Mono17x34_Bold;
	MOV	#1945, W0
	MOV	#0, W1
...
;mmbInput_driver.c,692 :: 		MCU.TextAlign             = _taRight;
	...
	MOV.B	#2, W0
	MOV.B	W0, [W1]
;mmbInput_driver.c,693 :: 		MCU.FontName        = DejaVu_Sans_Mono17x34_Bold;
	MOV	#1945, W0
	MOV	#0, W1
	MOV	W0, _MCU+24
	MOV	W1, _MCU+26
...
;mmbInput_driver.c,1114 :: 		CLKDIVbits.PLLPRE = 0;      // PLLPRE<4:0> = 0  ->  N1 = 2    8MHz / 2 = 4MHz
	...
	MOV	#lo_addr(CLKDIVbits), W0
	MOV.B	W1, [W0]
;mmbInput_driver.c,1116 :: 		PLLFBD =   30;              // PLLDIV<8:0> = 30 ->  M = 32    4MHz * 32 = 128MHz
	MOV	#30, W0
	MOV	WREG, PLLFBD
;mmbInput_driver.c,1118 :: 		CLKDIVbits.PLLPOST = 0;     // PLLPOST<1:0> = 0 ->  N2 = 2    128MHz / 2 = 64MHz
	MOV	#lo_addr(CLKDIVbits), W0
	MOV.B	[W0], W1
	MOV.B	#63, W0
	AND.B	W1, W0, W1
