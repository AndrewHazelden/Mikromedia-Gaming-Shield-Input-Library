#line 1 "X:/Mikromedia Board/MMB Input Demo/Release V0.2 - Dec 1, 2012/Mikromedia Gaming Shield Input Libray/Development/dsPIC33 v1.10 boards/mmbInput_Code/mikroC PRO for dsPIC/mmbInput_events_code.c"
#line 1 "x:/mikromedia board/mmb input demo/release v0.2 - dec 1, 2012/mikromedia gaming shield input libray/development/dspic33 v1.10 boards/mmbinput_code/mikroc pro for dspic/mmbinput_objects.h"
...
void Check_TP();
void Start_TP();
#line 1 "x:/mikromedia board/mmb input demo/release v0.2 - dec 1, 2012/mikromedia gaming shield input libray/development/dspic33 v1.10 boards/mmbinput_code/mikroc pro for dspic/mmbinput_resources.h"
#line 1 "x:/mikromedia board/mmb input demo/release v0.2 - dec 1, 2012/mikromedia gaming shield input libray/development/dspic33 v1.10 boards/mmbinput_code/mikroc pro for dspic/gaming-shield.h"
#line 82 "x:/mikromedia board/mmb input demo/release v0.2 - dec 1, 2012/mikromedia gaming shield input libray/development/dspic33 v1.10 boards/mmbinput_code/mikroc pro for dspic/gaming-shield.h"
sbit upButton at PORTD.B14;
sbit downButton at PORTD.B15;
sbit rightButton at PORTD.B6;
sbit leftButton at PORTD.B9;
sbit triangleButton at PORTF.B12;
sbit xButton at PORTF.B13;
sbit circleButton at PORTF.B0;
sbit squareButton at PORTC.B2;
...
sbit triangleButtonDirection at TRISF.B12;
sbit xButtonDirection at TRISF.B13;
sbit circleButtonDirection at TRISF.B0;
sbit squareButtonDirection at TRISC.B2;
...
#line 246 "x:/mikromedia board/mmb input demo/release v0.2 - dec 1, 2012/mikromedia gaming shield input libray/development/dspic33 v1.10 boards/mmbinput_code/mikroc pro for dspic/gaming-shield.h"
void InitGameShield(){
...
#line 8 "X:/Mikromedia Board/MMB Input Demo/Release V0.2 - Dec 1, 2012/Mikromedia Gaming Shield Input Libray/Development/dsPIC33 v1.10 boards/mmbInput_Code/mikroC PRO for dsPIC/mmbInput_events_code.c"
void Check_GS();
...
void Check_GS(){
 ...
 DrawButton(&MCU);
#line 39 "X:/Mikromedia Board/MMB Input Demo/Release V0.2 - Dec 1, 2012/Mikromedia Gaming Shield Input Libray/Development/dsPIC33 v1.10 boards/mmbInput_Code/mikroC PRO for dsPIC/mmbInput_events_code.c"
