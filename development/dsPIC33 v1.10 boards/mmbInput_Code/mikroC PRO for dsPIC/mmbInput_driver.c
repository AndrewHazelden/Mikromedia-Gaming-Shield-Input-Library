...
static void InitializeObjects() {
  ...
  Image1.Picture_Name   = carbon_bmp;
  Image1.Visible        = 1;
  Image1.Active         = 1;
  Image1.OnUpPtr         = 0;
  Image1.OnDownPtr       = 0;
  ...
  Led1Button.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  Led2Button.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  Led3Button.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  Led4Button.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  left.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  right.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  up.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  down.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  square.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  circle.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  triangle.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  x.Caption         = x_Caption;
  x.TextAlign            = _taLeft;
  x.FontName        = DejaVu_Sans_Mono13x16_Bold;
  x.PressColEnabled = 1;
  x.Font_Color      = 0xFFFF;
  x.Gradient        = 1;
  ...
  start.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  StatusLEDsText.FontName        = DejaVu_Sans_Mono13x16_Bold;
  ...
  ProgramCaption.FontName        = DejaVu_Sans_Mono28x34_Bold;
  ...
  MCU.FontName        = DejaVu_Sans_Mono28x34_Bold;
